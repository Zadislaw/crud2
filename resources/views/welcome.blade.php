...
<!--        <i class="fas fa-graduation-cap"></i>
      ...
      <form action="/">
        ...
        <div class="info">
          ...
          <input type="lname" name="name" placeholder="Last Name">
          <input type="text" name="name" placeholder="Date of Birth">
          <input type="text" name="name" placeholder="Email">

          <select>
            <option value="course-type" selected>Gender*</option>
            <option value="short-courses">Male</option>
            <option value="featured-courses">Female</option>
            <option value="featured-courses">Others</option>
          </select>
        </div>
        <div class="checkbox">
